...
export function CreateCourse() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    const url = `${import.meta.env.VITE_REST_SERVICE}/courses`;
  ...
  function onCancel() {
    navigate("/courses");
    toast.success("Berhasil membatalkan perubahan mata kuliah");
  }
  ...
  return (
    <>
      ...
      <div className="mt-16 flex min-h-screen w-full flex-col gap-2.5 px-5 py-2.5">
        <p className="text-xs">Buat Mata Kuliah Premium</p>
